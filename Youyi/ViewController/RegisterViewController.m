...
- (void)addSubViews
{
    ...
    [iconImgView setImage:[UIImage imageNamed:@"icon@2x"]];
    ...
    [_sendCodeBtn setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@""]] forState:UIControlStateNormal];
    ...
    registerBtn.tag = 106;
    [registerBtn setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@""]] forState:UIControlStateNormal];
    [registerBtn setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@""]] forState:UIControlStateHighlighted];
     ...
     [client postPath:@"register"
           parameters:pams
             ...
             [XCommon showAlertWithTitle:@"温馨提示" message:[NSString stringWithFormat:@"%@",error]];
                 ...
                 [XCommon UserDefaultSetValue:_nickNameTF.text forKey:NIKENAME];
