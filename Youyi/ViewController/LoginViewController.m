...
- (void)addLoginView
{
    ...
    if (_isRememberPwd) {
        [_rememberPwdBtn setImage:[UIImage imageNamed:[NSString stringWithFormat:@""]] forState:UIControlStateNormal];
    }else{
    ...
    loginBtn.tag = 103;
    [loginBtn setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@""]] forState:UIControlStateNormal];
    [loginBtn setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@""]] forState:UIControlStateHighlighted];
